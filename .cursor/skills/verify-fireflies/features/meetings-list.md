...
- `list-rows` shows a preview tile, `meeting.name`, status chip, optional summary, and timestamp. Video uses the thumbnail. Audio uses a Mic with sr-only `Audio recording`.
